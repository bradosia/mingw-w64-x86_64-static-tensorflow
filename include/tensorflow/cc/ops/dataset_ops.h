...
#ifndef C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATASET_OPS_H_
#define C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATASET_OPS_H_
...
/// Returns:
/// * the created `Operation`
class EnqueueInQueueDataset {
 public:
  EnqueueInQueueDataset(const ::tensorflow::Scope& scope, ::tensorflow::Input
                      queue, ::tensorflow::InputList components);
  operator ::tensorflow::Operation() const { return operation; }
...
/// Returns:
/// * `Output`: The handle tensor.
class PrependFromQueueAndPaddedBatchDataset {
 public:
  PrependFromQueueAndPaddedBatchDataset(const ::tensorflow::Scope& scope,
...
class SlideDataset {
 public:
  SlideDataset(const ::tensorflow::Scope& scope, ::tensorflow::Input
             input_dataset, ::tensorflow::Input window_size,
             ::tensorflow::Input stride, const DataTypeSlice& output_types,
             const gtl::ArraySlice<PartialTensorShape>& output_shapes);
  operator ::tensorflow::Output() const { return handle; }
  operator ::tensorflow::Input() const { return handle; }
  ::tensorflow::Node* node() const { return handle.node(); }
...
#endif  // C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATASET_OPS_H_
